...
st.text("Esta herramienta permite calcular la cantidad óptima de reposición por producto, teniendo en cuenta el stock disponible, los vencimientos en origen y el consumo promedio. Facilita la planificación anticipada, minimizando riesgos de quiebre de stock y optimizando las decisiones de compra en función de la proyección de cobertura.")
